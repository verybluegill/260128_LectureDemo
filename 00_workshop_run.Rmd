...
h_out <- mse_loop(
  ...
  hcr_type = "hockey",
  hcr_par = list(beta = beta_hcr, Bban_ratio = 0.3, Blim_ratio = 0.6, K_ref_type = "true"),
  use_cpp = use_cpp
)

B_true_h <- h_out$B_true
C_true_h <- h_out$C_true
I_obs_h <- h_out$I_obs
...
B_true_2k <- t2_out$B_true
C_true_2k <- t2_out$C_true
I_obs_2k <- t2_out$I_obs
